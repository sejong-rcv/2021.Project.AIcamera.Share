...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--isdecoder', action='store_true', help='generator decoder')
    ...
    # easy config modification
        ...
        # self.parser.add_argument("--batch-size", type=int, help="batch size for single GPU")
        # self.parser.add_argument("--data-path", type=str, help="path to dataset")
        self.parser.add_argument(
            "--zip",
            action="store_true",
        ...
        self.parser.add_argument("--eval", action="store_true", help="Perform evaluation only")
        self.parser.add_argument(
    ...
    def parse(self, save=True):
        ...
        self.opt.config = get_config(self.opt)
