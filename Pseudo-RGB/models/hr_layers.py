...
class Conv3x3(nn.Module):
    ...
    """
    def __init__(self, in_channels, out_channels, use_refl=True, kernel_size=3,padding=0):
        ...
        self.conv = nn.Conv2d(int(in_channels), int(out_channels), kernel_size=kernel_size, padding=padding)
